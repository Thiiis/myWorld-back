...
public class DiaryController {
  ...
  public ResponseEntity<DiaryCreateResponse> createDiary(@RequestPart("request") DiaryCreateRequest dto,
  ...
  public ResponseEntity<Void> updateDiary(@PathVariable("did") Long did, @RequestPart("dto") DiaryUpdateRequest dto,
                                          @RequestPart(value = "files", required = false) List<MultipartFile> files) {
